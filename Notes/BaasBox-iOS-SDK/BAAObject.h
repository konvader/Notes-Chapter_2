...
- (instancetype) initWithDictionary:(NSDictionary *)dictionary NS_DESIGNATED_INITIALIZER; //__attribute((objc_designated_initializer)); // Will be NS_DESIGNATED_INITIALIZER in Xcode6
